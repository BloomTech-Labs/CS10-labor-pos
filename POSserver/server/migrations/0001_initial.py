# Generated by Django 2.1.1 on 2018-09-12 03:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hashed_security_answer', models.TextField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('modified_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.AddField(
            model_name='account',
            name='job',
            field=models.ManyToManyField(related_name='account_jobs', to='server.Job'),
        ),
        migrations.AddField(
            model_name='account',
            name='note',
            field=models.ManyToManyField(related_name='account_notes', to='server.Note'),
        ),
    ]
